//From https://github.com/Karthik-B-06/RN-AnimatedTextInput
  ...
  useEffect(() => {
    if (nameTapped) {
      ...
      Animated.parallel([
        ...
        textInputRef.current?.focus(); //.getNode()
      });
    } else {
      setEditValue(false);
...
const arePropsEqual = (prevProps, nextProps) => {
  //console.log("Prop check: ",prevProps, " & ", nextProps)
  const hasValueChanged = isEqual(prevProps.value, nextProps.value); //i.e. {first_name:xxx,last_name:xxx}
